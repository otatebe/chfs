...
-c scratch_dir
: specifies a scratch directory or a devdax device.  If the directory does not exist, it will be created.  When a devdax device is specified, the pmem obj pool should be created with the layout pmemkv in advance.  Default is /tmp/$USER.
