...
## Updated features
- relative path support.  When CHFS_SUBDIR_PATH is specified, current working directory in CHFS is changed to $CHFS_SUBDIR_PATH.
...
- chfs_stat() - fake ino
- chfs_readlink() - check file type
- readonly files can be cached
