...
mpirun -x ROMIO_FSTYPE_FORCE=chfs: --mca io romio321 -x PATH -x CHFS_SERVER -x CHFS_BACKEND_PATH -x CHFS_SUBDIR_PATH -np 4 -hostfile hosts -map-by node rdbench -o rdbench/o -i 10 -s 100
